...
public class Agent {
	...
	public Agent(String nombre, String password, String email, String identificador, String ubicacion, String kind,
			int kindCode) {
		super();
		this.nombre = nombre;
	...
	public String toString() {
		return "Agent [nombre=" + nombre + ", email=" + email + ", ubicacion=" + ubicacion + ", identificador="
				+ identificador + ", kind=" + kind + ", kindCode=" + kindCode + "]";
	}
